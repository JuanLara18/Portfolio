			...
			>
				<div className="p-5 flex flex-col h-full">
					<div className="flex items-center justify-between mb-6 border-b border-gray-100 dark:border-gray-800 pb-5">
						...
						<button onClick={onClose} aria-label="Close menu" className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 transition-colors">
							<X size={20} />
						</button>
					</div>
					...
					<div className="mt-auto">
						<div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-5">
							...
							<div className="grid grid-cols-3 gap-2">
								<Link to="https://www.linkedin.com/in/julara/?locale=en_US" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 p-3 rounded-lg transition-colors">
									<Linkedin size={20} />
									<span className="text-xs mt-1">LinkedIn</span>
								</Link>
								<Link to="https://github.com/JuanLara18" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 p-3 rounded-lg transition-colors">
									<Github size={20} />
									<span className="text-xs mt-1">GitHub</span>
								</Link>
								<Link to="/documents/CV___EN.pdf" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center bg-white dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 p-3 rounded-lg transition-colors">
									<FileText size={20} />
									<span className="text-xs mt-1">Resume</span>
								</Link>
							</div>
						</div>
						<div className="text-center text-gray-500 dark:text-gray-400 text-xs py-4">© {new Date().getFullYear()} Juan Lara<div className="mt-1">Computer Scientist & Mathematician</div></div>
					</div>
				</div>
			</motion.div>
		</>
